    ...
    return (
        <div >
            ...
            <div style={{ paddingLeft: 35, paddingRight: 35, backgroundColor: 'white', padding: 2, marginLeft: -130, maxWidth: 600, maxHeight: 670, textAlign: 'left', marginBottom:'1rem', borderRadius:35, opacity:'0.91'}}>
                ...
                <TextField id="outlined-basic" label="Password" variant="outlined" sx={{margin: 0, width: { sm:400, md:400}}}/><br></br><br></br>
                <p style={{color: 'brown', fontSize: '15px'}}>  <a href="https://www.youtube.com"  className="links">Forgot password?</a></p><br></br>
                <Button variant="contained" style={{backgroundColor: '#D2A857', marginLeft: 140, marginTop:25, paddingInline:40, marginBottom:'45px', textAlign: 'center', borderRadius:20}}>Log in</Button>
